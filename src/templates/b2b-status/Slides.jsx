...
const DONE = [
  ...
  "Typ zamówienia: cykliczne (1×/miesiąc na punkt dostawy) vs domówienie (bez limitu)",
  "Koszyki szablonowe — zestaw produktów per punkt dostawy (edycja + import XLSX), auto-podstawiany przy zamówieniu cyklicznym",
